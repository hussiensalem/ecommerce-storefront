...
function Hero() {
  ...
  <div className="relative z-10 text-gray-900 max-w-[320px] sm:max-w-2xl md:max-w-xl lg:max-w-2xl xl:max-w-3xl md:mr-16 pt-10 text-center md:text-left mx-auto md:mb-20">
        ...
        <button className="bg-gray-900 text-white text-base sm:text-lg md:text-base lg:text-lg px-8 sm:px-10 md:px-8 lg:px-10 py-3 sm:py-4 md:py-3 rounded-lg font-medium hover:bg-gray-800 transition">
          Shopping Now
        </button>
      </div>
    </section>
